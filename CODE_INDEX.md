...
- `faq.html` — Common setup, workflow, storage, and integration questions.
- `support-policy.html` — Public release and support policy.

## Shared assets and contracts

- `assets/corecasex-logo.svg` — Official header, footer, and favicon logo.
- `assets/corecasex-logo.png` — Raster distribution copy of the official logo.
